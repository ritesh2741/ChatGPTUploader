...
class FileUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_upload" do
    assert_difference("FileUpload.count") do
      post file_uploads_url, params: { file_upload: { file_data: @file_upload.file_data, name: @file_upload.name } }
    end
  ...
  test "should update file_upload" do
    patch file_upload_url(@file_upload), params: { file_upload: { file_data: @file_upload.file_data, name: @file_upload.name } }
